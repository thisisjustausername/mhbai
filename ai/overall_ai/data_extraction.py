...
valid_full_info = {
    ...
    "requirements": [
        "Zulassung zum Studium der Hebammenwissenschaft"
    ],
    "expense": [
        {
            "activity": "Teilnahme an Lehrveranstaltungen (Präsenzstudium)",
            "hours": 42
        },
        {
...
def extract_module_info(module_text: str) -> ModuleInfo:
    """
    ...
    try:
        response = ollama.chat(
            ...
            messages=[
                {
                    "role": "system", 
                    "content": definition_model_position
                }, 
                {
                    "role": "user", 
