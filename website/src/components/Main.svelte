...
<main
	class="min-h-screen bg-white bg-gradient-to-b from-fuchsia-500 to-amber-500 dark:bg-black dark:bg-gradient-to-b dark:from-black dark:to-black"
>
	<div
	...
	>
		<!-- Info-Box -->
		<div
			class="mx-auto mb-15 max-w-3xl rounded-2xl border-3 border-fuchsia-800 bg-fuchsia-600/60 p-6 shadow-[inset_0_0_40px_rgba(50,0,50,0.3)] dark:border-fuchsia-500
      dark:bg-fuchsia-400 dark:bg-fuchsia-600/30 dark:shadow-[inset_0_0_20px_rgba(255,0,255,0.7)]"
		>
		...
		<!-- Info-Box -->
		<div
			class="mx-auto mb-15 max-w-3xl rounded-2xl border-3 border-rose-800 bg-rose-600/30
      p-6 shadow-[inset_0_0_20px_#9d174d70]
      dark:border-purple-400 dark:bg-purple-600/30 dark:shadow-[inset_0_0_20px_#9333ea]"
		...
		<div
			class="mx-auto max-w-3xl rounded-2xl border-3 border-red-800 bg-red-500/45
      ...
      dark:border-cyan-400 dark:bg-blue-600/20 dark:shadow-[inset_0_0_20px_#1e40af]"
		...
		<div
			class="mx-auto mt-12 max-w-3xl rounded-2xl border-3 border-amber-900 bg-amber-500/30
      p-6 shadow-[inset_0_0_20px_#92400e60]
      dark:border-teal-300 dark:bg-teal-600/30 dark:shadow-[inset_0_0_20px_#0f766e]"
		...
		<div
			class="mx-auto mt-12 max-w-3xl rounded-2xl border-3 border-yellow-900 bg-yellow-600/20 p-6
      shadow-[inset_0_0_20px_#a1620790]
